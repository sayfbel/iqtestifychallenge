...
import { getPythonResults } from '../dataUsers/dataUsers';
...
export default function PythonPage() {
    ...
    return (
        <div className="animate-fade-in">
            ...
            <div className="glass glass-panel" style={{ borderColor: 'var(--glass-border)' }}>
                        ...
                        <tbody>
                            {sortedData.map((user, index) => (
                                <tr key={index}>
                                    ...
                                    <td style={{ color: '#ef4444' }}>{user.wrongAttempts || 0}</td>
